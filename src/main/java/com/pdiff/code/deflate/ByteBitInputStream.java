package com.pdiff.code.deflate;
...
public final class ByteBitInputStream implements BitInputStream {
	...
	// Either in the range [0x00, 0xFF] if bits are available, or -1 if end of
	// stream is reached.
	private int currentByte;

	// Number of remaining bits in the current byte, always between 0 and 7
	// (inclusive).
